...
const config: Config = {
  ...
  testPathIgnorePatterns: [
    ...
    // '<rootDir>/__tests__/unit/Belcorp/',
    ...
    // '<rootDir>/__tests__/unit/Dashboard/help/FrequentQuestions.test.tsx',
    // '<rootDir>/__tests__/unit/Dashboard/help/Help.test.tsx',
    ...
    // '<rootDir>/__tests__/unit/Dashboard/Dashboard.test.tsx',
    // '<rootDir>/__tests__/unit/Identify/',
    // '<rootDir>/__tests__/unit/PasswordRecover/',
    // '<rootDir>/__tests__/unit/Signin/',
    // '<rootDir>/__tests__/unit/Signup/',
    // '<rootDir>/__tests__/unit/WebViews/',
  ],
};
