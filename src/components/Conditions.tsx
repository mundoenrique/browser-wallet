  ...
  return (
    <>
      ...
      <Stack spacing={2} sx={{ px: { xs: 2, md: 0 }, textAlign: 'justify', mb: { xs: 10, md: 0 } }}>
        ...
        <Typography paragraph>
          Cuenta: cuenta general de dinero electrónico, cuya titularidad es del CLIENTEA
        </Typography>
        <Typography paragraph>
        ...
        <Typography paragraph>
          Emisión: la conversión de dinero electrónico por el mismo valor que se recibe, a través de su almacenamiento
          en un soporte electrónico; incluye la emisión propiamente dicho, la reconversión a efectivo &#40;retiros&#41;,
        ...
        <List sx={{ listStyleType: 'lower-alpha', pl: 2 }}>
          ...
          <ListItem sx={{ display: 'list-item', p: 0 }}>
            <Typography paragraph>
              ...
              afiliados a las marcas Visa, según corresponda a la Tarjeta. El valor del consumo será debitado de la
              Cuenta y se indicará en el voucher. Asimismo, el CLIENTE podrá realizar consumos en páginas web, locales e
              internacionales. En cualquier caso, los consumos podrán efectuarse en cualquier moneda, en cuyo caso
              estarán sujetos al tipo de cambio.
            </Typography>
          </ListItem>
          <ListItem sx={{ display: 'list-item', p: 0 }}>
            <Typography paragraph>
        ...
        <Typography paragraph>
          El CLIENTE podrá encontrar el detalle de las instrucciones para efectuar operaciones con la Tarjeta a través
          los canales de comunicación establecidos para Yiro.
        </Typography>
        <Typography paragraph>
          4.2. Límites y Restricciones Las operaciones que realice el CLIENTE con la Tarjeta estarán sujetas a los
          límites transaccionales cuyo detalle se encuentra en los Términos y Condiciones aceptados por el CLIENTE al
          abrir la cuenta y en Yiro desde el App/Web de SomosBelcorp.
        </Typography>
        <Typography paragraph>
          <strong>QUINTA. CONDICIONES DE USO DE LA TARJETA:</strong> La Tarjeta será magnetizada y numerada y vendrá en
          un sobre cerrado y sellado el cual también contendrá las condiciones de uso de la Tarjeta. Con la Tarjeta, el
          CLIENTE podrá realizar transacciones, en Soles y Dólares de los Estados Unidos de América, en el Perú y en el
          extranjero. La Tarjeta es prepago por lo que el uso de la misma estará condicionado a que la Cuenta tenga
          saldo disponible. El CLIENTE asume plena responsabilidad por el resguardo y mal uso de la Tarjeta, así como
          por la pérdida o hurto de la misma, debiendo informar inmediatamente a SERVITEBCA por los medios definidos en
          el presente Contrato.
        </Typography>
        <Typography paragraph>
          <strong>SEXTA. CLAVE SECRETA:</strong> Junto con la Tarjeta, SERVITEBCA entregará a EL CLIENTE una clave
          secreta &#40;en adelante, la “Clave”&#41;. Dicha Clave será la única que podrá ser utilizada por EL CLIENTE
          para realizar consumos en establecimientos afiliados a la red de Visa, según corresponda a la Tarjeta, así
          como para efectuar disposiciones de efectivo en cajeros automáticos. El CLIENTE asume responsabilidad por
          mantener en reserva y no divulgar las claves, ya que todas las transacciones realizadas mediante el uso de
          éstas serán consideradas como válidamente efectuadas por EL CLIENTE.
        </Typography>
        ...
        <List sx={{ listStyleType: 'upper-alpha', pl: 2 }}>
          <ListItem sx={{ display: 'list-item', p: 0 }}>
            ...
            <Typography paragraph>
              7.1. EL CLIENTE deberá bloquear la Cuenta en caso de hurto, robo o extravío de la Tarjeta o Clave, o en
              caso de que un tercero no autorizado tome conocimiento de cualquiera de las Claves, inmediatamente después
              de que ocurra cualquiera de estos hechos. EL CLIENTE podrá bloquear la Cuenta ingresando a Yiro desde el
              App/Web de Somos Belcorp, llamando al Centro de Contacto o a través de otros canales que se pondrán a su
              disposición y que le serán oportunamente informados. EL CLIENTE será responsable por las transacciones
              realizadas con la Tarjeta en tanto SERVITEBCA no haya recibido la respectiva solicitud de bloqueo.
            </Typography>
            <Typography paragraph>
              ...
              cuales 1 Ver Nota al pie anterior. estarán a disposición del cliente al ingresar a Yiro desde el App/Web
              de SomosBelcorp. El saldo se trasladará a la nueva Tarjeta. <br />
              &#40;ii&#41; En caso El CLIENTE no desee la reposición de la Tarjeta, podrá solicitar el reembolso del
              saldo disponible en la Tarjeta bloqueada, para lo cual deberá comunicarse con el Centro de Contacto para
              que le informe los mecanismos para la devolución. Dichos mecanismos para devolución del saldo remanente
              incluyen, según se determine, la entrega de dinero en efectivo o cheque.
            </Typography>
          </ListItem>
          <ListItem sx={{ display: 'list-item', p: 0 }}>
            ...
            <Typography paragraph>
              ...
              de Contacto. Para activar la Cuenta nuevamente, podrá hacerlo a través del App o del Centro de Contacto,
              en cuyo caso deberá pasar la validación positiva.
            </Typography>
            <Typography paragraph>
              ...
              deberá solicitar al Centro de Contacto la devolución. SERVITEBCA informará los mecanismos para la
              devolución &#40;entrega en efectivo o cheque&#41;, la cual se llevará a cabo en la oficina de SERVITEBCA.
            </Typography>
          </ListItem>
          <ListItem sx={{ display: 'list-item', p: 0 }}>
            ...
            <Typography paragraph>
              ...
              política de lavado de activos de SERVITEBCA de acuerdo con la ley de la materia o cuando el CLIENTE
              hubiera suministrado información inexacta, incompleta o falsa. En estos supuestos, SERVITEBCA le informará
              al CLIENTE de la medida adoptada mediante los canales de comunicación de la billetera Yiro,
            </Typography>
          </ListItem>
        </List>
        <Typography paragraph>
        ...
        <Typography paragraph>
          ...
          disponibles en la Tarjeta previa comunicación con el Centro de Contacto para que le informe los mecanismos
          para la devolución.
        </Typography>
        <Typography paragraph>
          ...
          disponibles en la Cuenta, cualquier costo, total o parcial, que se encuentre pactado en el presente Contrato.
          EL CLIENTE acepta que SERVITEBCA podrá rechazar las operaciones realizadas cuando la Cuenta no tenga saldo
          disponible para cubrir el pago de las comisiones y/o gastos, de acuerdo al presente Contrato. Si el saldo
          fuera insuficiente para cobrarse del mismo las comisiones/gastos en un plazo igual o mayor a seis &#40;6&#41;
          meses, EL CLIENTE autoriza expresamente a SERVITEBCA a resolver el Contrato y cancelar la Tarjeta.
        </Typography>
        <Typography paragraph>
        ...
        <Typography paragraph>
          ...
          modificaciones a las comisiones y/o gastos, resolución del Contrato, limitación o exoneración de
          responsabilidad por parte de SERVITEBCA así como la incorporación de servicios no relacionados directamente al
          servicio objeto del Contrato, serán enviadas al CLIENTE a través de cualquiera de los siguientes medios:
          &#40;i&#41; correos electrónicos, &#40;ii&#41; llamadas telefónicas o &#40;iii&#41; comunicaciones al
          domicilio. Dichas comunicaciones se enviarán con cuarenta y cinco &#40;45&#41; días de anticipación a su
          entrada en vigencia. Modificaciones contractuales distintas a las antes indicadas, serán informadas, con
          cuarenta y cinco &#40;45&#41; días de anticipación a su entrada en vigencia, a través de cualquiera de los
          siguientes medios: &#40;i&#41; ingresando a la billetera Yiro desde el App/Web de SomosBelcorp&#41;, o
          &#40;ii&#41; correos electrónicos y en general, cualquier otro medio electrónico que se disponga. En caso EL
          CLIENTE no estuviera de acuerdo con las modificaciones, podrá resolver el Contrato dentro de los plazos antes
          indicados. SERVITEBCA enviará a través de los canales dispuestos las comunicaciones directas según los datos
          consignados por EL CLIENTE, por lo que el CLIENTE se obliga a notificar a través de estos canales, cualquier
          cambio de los datos proporcionados
        </Typography>
        <Typography paragraph>
          EL CLIENTE podrá consultar sobre los servicios y procedimientos de SERVITEBCA a través de los siguientes
          canales de atención: &#40;i&#41; ingresando a la billetera Yiro desde el App/Web de SomosBelcorp &#40;ii&#41;
          Centro de Contacto, y cualquier otro que sea puesto ponga a su disposición
        </Typography>
        <Typography paragraph>
          Asimismo, EL CLIENTE podrá dirigir cualquier reclamo al Centro de Contacto vía llamada telefónica, Whatsapp y
          el correo electrónico autorizados.
        </Typography>
        <Typography paragraph>
          ...
          suministrado documentación y/o información falsa, incorrecta o contradictoria. A estos efectos, si el CLIENTE
          no brinda o rectifica la información solicitada dentro del plazo de siete &#40;7&#41; días calendario,
          SERVITEBCA procederá a bloquear la Cuenta y devolverá el saldo disponible en ésta, a través de los canales que
          se pondrán a su disposición y que le serán oportunamente informados,. . Del mismo modo, EL CLIENTE autoriza a
          SERVITEBCA, sin que ello implique obligación o responsabilidad por parte de SERVITEBCA, para que investigue,
          con las más amplias facultades, todo lo relativo a los presuntos usos indebidos de la Tarjeta y se compromete
          a prestarle toda la colaboración que ésta requiera.
        </Typography>
        <Typography paragraph>
        ...
        <Typography paragraph>
          ...
          someten a la competencia y jurisdicción de los jueces del lugar donde se celebra el Contrato. 17.2. El
          presente Contrato se regula bajo las normas aplicables de la República del Perú. 17.3. EL CLIENTE declara que:
          &#40;i&#41; suscribe este Contrato aceptando sus términos, &#40;ii&#41; las dudas sobre los términos y
          conceptos han sido absueltos y &#40;iii&#41; ha recibido la información/documentación necesaria respecto a la
